...
import { Navigation, Grid } from "swiper/modules" // Re-import Grid module
import "swiper/css/navigation"
import "swiper/css/grid" // Re-import grid styles
...
interface IBasicSlider {
  ...
  rows?: number // Re-add prop for grid rows
}
...
const BasicSlider = ({
  ...
  return (
    <div className="relative flex justify-center items-center py-5 w-[99%]" dir="rtl">
      <div
